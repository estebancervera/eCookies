                    ...
                    (err, orders) => {
                      if (err) {
                        ...
                        Order.find(
                          {
                            $and: [
                              { orderDate: { $gte: twoDaysP } },
                              { orderDate: { $lt: yesterday } },
                              { business: req.user.business },
                            ],
                          },
                          (err, orders) => {
                            if (err) {
                              ...
                              Order.find(
                                {
                                  $and: [
                                    { orderDate: { $gte: ThreeDaysP } },
                                    { orderDate: { $lt: twoDaysP } },
                                    { business: req.user.business },
                                  ],
                                },
                                (err, orders) => {
                                  if (err) {
                                    ...
                                    Order.find(
                                      {
                                        $and: [
                                          { orderDate: { $gte: FourDaysP } },
                                          { orderDate: { $lt: ThreeDaysP } },
                                          { business: req.user.business },
                                        ],
                                      },
                                      (err, orders) => {
